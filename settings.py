...
SEG_THRESHOLD = 0.05                       # the threshold used for visualization
SCORE_THRESHOLD = 0.05                      # the threshold used for IoU score (in HTML file)
...
if MODEL == 'resnet18':
    ...
    if DATASET == 'imagenet':
        MODEL_FILE = 'torchdistill/imagenet/%s/Imagenet-resnet18_from_resnet34.pt' % environment
        YAML_FILE  = 'torchdistill/configs/official/ilsvrc2012/yoshitomo-matsubara/rrpr2020/kd-resnet18_from_resnet34.yaml'
        MODEL_PARALLEL = False
elif MODEL == 'densenet161':
    FEATURE_NAMES = ['features']
    if DATASET == 'places365':
        MODEL_FILE = 'zoo/whole_densenet161_places365_python34.pth.tar'
        MODEL_PARALLEL = False
elif MODEL == 'resnet34':
    FEATURE_NAMES = ['layer4']
    if DATASET == 'places365':
        MODEL_FILE = 'zoo/whole_resnet50_places365_python34.pth.tar'
        MODEL_PARALLEL = False
    elif DATASET == 'imagenet' :
        MODEL_FILE = 'torchdistill/imagenet/%s/resnet34.pt' % environment
        MODEL_PARALLEL = False
elif MODEL == 'resnet50':
    FEATURE_NAMES = ['layer4']
    if DATASET == 'places365':
        ...
        MODEL_FILE = 'torchdistill/imagenet/%s/resnet50.pt' % environment
        MODEL_PARALLEL = False
elif MODEL == 'efficientnet_b0' or MODEL == 'efficientnet_b2':
    FEATURE_NAMES = ['features']
    if DATASET == 'places365':
        MODEL_FILE = 'zoo/whole_resnet50_places365_python36.pth.tar'
        MODEL_PARALLEL = False
    elif DATASET == 'imagenet':
        MODEL_FILE = 'torchdistill/imagenet/%s/Imagenet-efficientnet_b2.pt' % environment
        MODEL_PARALLEL = False

OUTPUT_FOLDER = "result/"+MODEL+environment+'_'+DATASET+'_'+FEATURE_NAMES[0] # result will be stored in this folder
